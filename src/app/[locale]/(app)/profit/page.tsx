...
const Carousel = function () {
    ...
    return (
        <div className="flex justify-center">
            <div className="w-[1200px] bg-gray-600/90 md:h-[800px] h-[900px] md:rounded-t-[80px] rounded-none bg-slate-300 relative overflow-hidden">
                ...
                <div className="flex justify-center items-center flex-col gap-3 px-10 mt-[50px]">
                    ...
                    <div className="text-white mw-[500px] mt-[20px] text-center text-lg leading-8">
                        {t('text1')}
                    </div>
                </div>
            </div>
    ...
    return (
        <div className="flex justify-center md:pb-[100px] pb-0">
            <div className="w-[1200px]">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-x-2 md:gap-x-6 text-color-2 text-lg leading-8 md:pt-[50px] pt-0">
