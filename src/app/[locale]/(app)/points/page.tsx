...
const Carousel = function () {
    return (
        <div className="flex justify-center">
            <div className="w-[1200px] grid grid-cols-2 bg-slate-300 h-[500px] rounded-t-[50px] bg-orange-400/80">
        ...
        <div className="flex justify-center">
            <div className="w-[1200px] py-[80px]">
                <div className="flex justify-bewteen">
                    <div className="flex justify-center items-center flex-col rounded-full bg-orange-500 w-[250px] h-[250px] border-[20px] ml-[80px] text-white">
