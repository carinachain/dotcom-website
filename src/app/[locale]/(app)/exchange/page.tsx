...
const Carousel = function () {
  return (
    <div className="flex justify-center">
      <div className="w-[1200px] grid grid-cols-2 bg-slate-300 h-[500px] rounded-t-[50px] overflow-hidden">
    ...
    return (
      <div className="flex justify-center">
        <div className="w-[1200px]">
          ...
          <div className="h-[650px] flex justify-between text-color-2 bg-[url(/images/index_function_bg.png)] bg-no-repeat bg-contain bg-bottom">
            <div className="flex flex-col items-center w-[380px] h-[550px] bg-orange-400 rounded-3xl">
